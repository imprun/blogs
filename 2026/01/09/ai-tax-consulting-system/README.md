...
| # | 제목 | 핵심 질문 |
|---|------|----------|
| 1 | [온톨로지란 무엇인가: 컴퓨터에게 세상을 가르치는 방법](https://blog.imprun.dev/121) | 왜 데이터에 "의미"를 부여해야 하는가? |
| 2 | [지식그래프 입문: RDB vs Graph DB, 언제 무엇을 쓰는가](https://blog.imprun.dev/122) | 관계형 DB와 그래프 DB의 차이는? |
| 3 | [AI 에이전트 개념: 도구를 사용하는 AI](https://blog.imprun.dev/123) | 에이전트가 "도구"를 사용한다는 것의 의미는? |
| 4 | [세무 AI 시스템 아키텍처 설계](https://blog.imprun.dev/124) | 전체 시스템을 어떻게 구성하는가? |
...
| # | 제목 | 핵심 질문 |
|---|------|----------|
| 10 | [LangChain 입문: 첫 번째 체인 만들기](https://blog.imprun.dev/130) | 체인의 개념과 조합 방법은? |
| 11 | [RAG 구현: 문서 기반 질의응답](https://blog.imprun.dev/131) | 검색 증강 생성의 아키텍처는? |
| 12 | [LangGraph로 상태 기반 에이전트 구축](https://blog.imprun.dev/132) | 복잡한 워크플로우를 어떻게 그래프로 표현하는가? |
| 13 | [커스텀 도구(Tool) 만들기](https://blog.imprun.dev/133) | 에이전트가 사용할 도구를 어떻게 설계하는가? |
...
| 16 | [GraphRAG: 지식그래프 + LLM 통합](https://blog.imprun.dev/136) | 구조화된 지식을 LLM 컨텍스트로 어떻게 활용하는가? |
| 17 | [세무 분석 에이전트 구현](https://blog.imprun.dev/137) | 자율적으로 분석하는 에이전트를 어떻게 설계하는가? |
